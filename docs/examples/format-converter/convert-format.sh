...
SPARK_TOOLS_VERSION="0.1.0-SNAPSHOT"
SPARK_TOOLS_JAR="$SPARK_TOOLS_ARTIFACT-$SPARK_TOOLS_VERSION.jar"

SPARK_UTILS_ARTIFACT="spark-utils_2.11"
SPARK_UTILS_VERSION="0.2.0-SNAPSHOT"
SPARK_UTILS_JAR="spark-utils_2.11-$SPARK_UTILS_VERSION.jar"

SCALA_UTILS_ARTIFACT="scala-utils_2.11"
SCALA_UTILS_VERSION="0.2.0-SNAPSHOT"
SCALA_UTILS_JAR="scala-utils_2.11-$SPARK_UTILS_VERSION.jar"
